...
=== Microprofile vs. Microservice

image:microprofile_4_1.png[]

=== JSR

* https://jakarta.ee/specifications/[Jakarta specifications]

* https://download.eclipse.org/microprofile/microprofile-3.3/microprofile-spec-3.3.html[Microprofile Specifications]
